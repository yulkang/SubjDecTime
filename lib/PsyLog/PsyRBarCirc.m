classdef PsyRBarCirc < PsyPTB & PsyRStream
    properties
        %% Aperture
        apCenterDeg   = [0 0];
        apRDeg        = 2.5;
    ...
    methods
        %% Before experiment
        function me = PsyRBarCirc(cScr, varargin)
            me = me@PsyPTB;
            me.updateOn = {'befDraw'};
        ...
        function initTrial(me)
            ...
            %% Allocate memory
            me.xyPix    = zeros(2, me.nBar);
            me.bar2     = false(1, me.nBar);
            me.col2     = false(1, me.nBar);
            
            % toShow: in square sampling, will be updated. 
            %         in circle sampling, will remain unchanged.
            me.toShow   = true(1, me.nBar);
        end
        ...
        function updateXY(me)
            % Jumps
            toJump = rand(me.rStream, 1, me.nBar) > abs(me.coh);
        ...
        function updateCol(me)
            ...
            me.col2(1,:) = (rand(me.rStream, 1, me.nBar) < me.prop);
        end
