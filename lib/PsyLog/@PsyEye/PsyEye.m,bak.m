...
%                     % Wait 0.5ms to help draining to succeed
%                     % : Unused. Doesn't help.
%                     WaitSecs(0.0005);  
                end
...
%                 if ~isempty(cEvt) % UNUSED for now.
%                     Eye.evt           = cEvt;
%                     
%                     if Eye.saveDat.evt
%                         addLog(Eye, {'evt'}, ...
%                             repmat(Eye.sampledAbsSec, [1 size(cEvt,2)]), {cEvt});
%                     end
%                     
%                     % Assume that evt doesn't arise without a sample.
%                     % Thus, skip sampledAbsSec and ELTimeAbsSec.
%                 end
%                 
%                 % debug --
%                 iLoop = iLoop + 1;
...
%             fprintf('Elapsed'); fprintf(' %1.2f', diff(tSamp(1:iLoop))*1e3); fprintf(' ms!\n\n');
%             % -- debug
        end
