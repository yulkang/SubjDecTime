...
gabortex = CreateProceduralGabor(win, tw, th, nonsymmetric, [0.5 0.5 0.5 0]);
...
rect_dst = [0 0 tw th; 0 0 tw th]';
Screen('DrawTextures', win, gabortex, [], rect_dst, [90+tilt, 180+tilt], [], 128, [], [], kPsychDontDoRotation, [phase+180, freq, sc, contrast, aspectratio, 0, 0, 0]');
...
while count < 10000
    ...
    Screen('DrawTextures', win, gabortex, [], rect_dst, [90+tilt, 180+tilt], [], 128, [], [], kPsychDontDoRotation, [180-phase, freq, sc, contrast, aspectratio, 0, 0, 0]');
