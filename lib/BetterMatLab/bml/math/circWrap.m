function x = circWrap(x, py, signDx, th, rAp)
...
x = -signDx * cos(th) ... % on the other side of the moving direction,
    + (x - signDx*sqrt(rAp^2 - py.^2)); % add the 'excessive' displacement.