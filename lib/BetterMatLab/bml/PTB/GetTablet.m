function [x,y,buttons,focus,valuators,valinfo] = GetTablet(windowPtrOrScreenNumber, mouseDev)
% Assumes numButtons = 3 but otherwise identical to GetMouse.
% Avoids fatal crash in MATLAB 64-bit with Wacom tablets.
%
% [x,y,buttons,focus,valuators,valinfo] = GetTablet([windowPtrOrScreenNumber][, mouseDev])
%
