...
%
% update: (2013-10-07 YK)
%      The original 1.0 alpha saved an empty cell array as 'null', which was
%      read by loadjson as an empty numerical array. Now savejson_cell saves
%      an empty cell array as '[]', which correctly reproduces the original.
