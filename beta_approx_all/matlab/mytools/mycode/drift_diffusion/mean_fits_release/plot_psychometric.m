...
% split     ([0] 1) split rt at zero to allow different tnd
% xsplit    (0 [1]) split x axis near 0 
% col        'k'    plot color
...
addParameter(pSet,'split',0);  % split rt at zero to allow differnet tnd
...
if folded
    ...
    if rt
        ...
        if data
            errbar(x1,S.m,S.se,'b','linewidth',1,'Color',col,'Marker','o')
            h=plot(x1,S.m,'o','MarkerFace',col,'MarkerSize',gms,'Color',col,'MarkerEdgeColor',col);
            set(h,'linewidth',glw);
        end    
